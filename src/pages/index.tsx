  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Dating - Your personalized platform for connection. Offering trusted profiles, precision matching, engaging communication, location-based services, and intuitive discovery. Making your journey towards love more exciting and safe."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1516210938721-0703012a297a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXRpbmclMjBhcHB8ZW58MHx8fHwxNjkzOTg3OTE2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Dating - Your personalized platform for connection. Offering trusted profiles, precision matching, engaging communication, location-based services, and intuitive discovery. Making your journey towards love more exciting and safe.`}
            </Text>
            <Box
