            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('social_media', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/social-medias/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Platform Name" text={data?.platform_name} />

                <FormListItem label="Profile Link" text={data?.profile_link} />
